...
<img src="label_system/img/login.png" alt="login" style="width:50%;"/>
...
<img src="label_system/img/register.png" alt="register" style="width:50%;"/>
...
<img src="label_system/img/match.png" alt="match" style="width:70%;"/>
...
<img src="label_system/img/admin.png" alt="admin" style="width:110%;"/>
...
+ 導入任務步驟
    ...
    <img src="label_system/img/result_file.png" alt="result_file" style="width:110%;"/>

    2. 再回到管理首頁，點擊`點此導入`連結導入任務。若導入成功，系統會告知導入成功的任務數量。

    <img src="label_system/img/import.png" alt="import" style="width:110%;"/>

    3. 可到 `Task` 分頁查看詳細的任務敘述。

    <img src="label_system/img/task.png" alt="task" style="width:110%;"/>
